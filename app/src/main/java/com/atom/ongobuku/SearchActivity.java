...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ongoNumber = findViewById(R.id.ongo_number);
        textView = findViewById(R.id.text_view);
        ongoNumber.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                String number = ongoNumber.getText().toString();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.ongowere:
                Intent x = new Intent(SearchActivity.this, OngoWere.class);
                startActivity(x);
                break;
            case R.id.about:
                Intent v = new Intent(SearchActivity.this,AboutActivity.class);
                startActivity(v);
                break;
        }
    ...
    public void search(MenuItem item) {
        ...
        if (number.equals("1")) {
            ...
            Intent intent = new Intent(SearchActivity.this, PageView.class);
            ...
            String title = "Ongo(17) Mvi Munguni osita Yesuni (Once in royal David's city)";
        ...
        else if (number.equals("252")){
            String title = "Ongo(252)";
